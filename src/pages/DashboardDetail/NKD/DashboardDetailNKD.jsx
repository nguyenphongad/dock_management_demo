...
const DashboardDetailNKD = () => {
  ...
  useEffect(() => {
    const updateVehicles = () => {
      ...
      saveChartDataToStorage(WAREHOUSE_TYPES.NKD, chartData);
    };

    // Load from localStorage first
    const savedData = loadChartDataFromStorage(WAREHOUSE_TYPES.NKD);
    if (savedData) {
  ...
  return (
    <div className="dashboard-detail dashboard-detail--nkd">
      <DashboardHeader 
        title="Dashboard Detail - NKD"
      ...
      <div className="dashboard-detail__content">
        ...
        <div className="vehicle-activity-table">
          <h3 className="vehicle-activity-table__title">🚛 Chi Tiết Hoạt Động Xe - Kho NKD</h3>
...
export default DashboardDetailNKD;
